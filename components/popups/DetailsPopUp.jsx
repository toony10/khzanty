...
const DetailsPopUp = ({ imageSrc, name, details, code, onClose }) => {
  return (
    <div
      ...
      <div className='max-w-sm rounded-lg overflow-hidden shadow-lg bg-white w-96'>
        <Image
        ...
        <div className='px-6 py-4'>
          <div className='font-bold text-xl mb-2 text-right'>{name}</div>
          <p className='text-gray-700 text-base text-right'>{details}</p>
        </div>
