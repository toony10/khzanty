    ...
    <section className='bg-white' id='contact'>
      <div className='py-8 lg:py-16 px-4 mx-auto max-w-screen-md'>
        ...
        <form ref={form} className='space-y-8' onSubmit={sendEmail}>
          ...
          <div
            id='alert'
            className='m-auto mb-5 ease-in duration-200  justify-center text-green-600 bg-green-400 w-1/2 items-center rounded-lg bg-success-100 px-6 py-5 text-base text-success-700'
            role='alert'>
